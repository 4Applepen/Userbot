...
async def _(event):
    ...
    message = "Uso: `.iffuci <testo lungo da includere>`"
    if input_str:
        message = input_str
    ...
    if r["isUrl"]:
        ...
        await event.edit("il codice viene incollato su {} in {} secondi. Vai all'URL originale: {}".format(url, ms, nurl))
    else:
        await event.edit("il codice viene incollato su {} in {} secondi".format(url, ms))
