    ...
    def download_page(self,url):
        ...
        if cur_version >= version:  # If the Current Version of Python is 3.0 or above
            try:
                ...
                print("Impossibile aprire l'URL. Controlla la tua connessione Internet e / o le impostazioni SSL\n"
                      "Se utilizzi un proxy, assicurati che le impostazioni del proxy siano configurate correttamente")
                sys.exit()
        else:  # If the Current Version of Python is 2.x
            try:
                headers = {}
